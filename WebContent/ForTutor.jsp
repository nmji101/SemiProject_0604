...
<!--                       <input type="button"  class="btn addr" value="주소저장" id=findaddr> -->
         ...
         <div class=row>
            ...
            <button type="button" class="btn btn-warning openlist">MY CLASS 모아보기</button>
               ...
               <div class="head col-lg-1 col-md-1 col-sm-2 d-none d-sm-block m-0 p-0">번호</div>
               <div class="head  col-lg-1 col-md-1 col-sm-2 d-none d-sm-block m-0 p-0">분류</div>
               <div class="head  col-lg-4 col-md-3 col-sm-6 m-0 p-0 ">제목</div>
...
<!--                <div class="mains2 col-lg-6 col-md-5 col-sm-6 "> -->
<%-- 				<a href = "click.board?seq=${tmp.seq}"> --%>
<%-- 				${tmp.title} --%>
<!-- 				</a> -->
<!-- 				</div> -->
